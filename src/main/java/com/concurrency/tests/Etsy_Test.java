...
public class Etsy_Test {
    ...
    public void test1() throws Exception{
        /**
         * This code to run etsy tests locally not in the cloud
         * {
        ...
        desiredCapabilities.setCapability("app", "https://-appium.s3.amazonaws.com/etsy.apk");
